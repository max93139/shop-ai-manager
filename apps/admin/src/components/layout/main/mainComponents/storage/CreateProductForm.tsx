    ...
    <div className="flex flex-col gap-6 p-4 sm:p-7 lg:p-8 max-w-[1200px] mx-auto w-full select-none">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <button
            type="button"
            onClick={() => onSave?.({ name, category, brand, price, selectedSizes, selectedColors, inStock, reserved, imageUrls })}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-5 sm:gap-6">
          {/* Card 1: Product Images / Hero Placeholder with Drag & Drop */}
