...
6. **Mobile First & Full Responsiveness Rule**: Any frontend changes, components, pages, or layout updates MUST be 100% responsive and tested/optimized for mobile devices and tablets (mobile drawers, touch targets, flexible layouts, no horizontal overflows).
