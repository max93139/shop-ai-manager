...
- **Mobile First Responsiveness Rule**: Every frontend page, component, or layout modification MUST be 100% responsive and function seamlessly on mobile devices (smartphones, tablets) as well as desktop viewports.
